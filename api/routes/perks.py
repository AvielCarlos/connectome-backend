...
LEVEL_PERKS = {
    ...
    "level_20_aura_memory":     (20, "free",       "Aura remembers your preferences more deeply"),
    "explorer_daily_cards":    (1,  "explorer",   "50 feed cards/day (vs 10 free)"),
    "explorer_xp_boost":       (1,  "explorer",   "1.5x XP on everything"),
    "explorer_goal_coaching":  (5,  "explorer",   "Unlock deep goal coaching sessions with Aura"),
    ...
    "sovereign_priority_ora":  (1,  "sovereign",  "Priority Aura responses + longer context"),
