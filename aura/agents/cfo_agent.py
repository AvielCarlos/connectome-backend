"""
CFO Agent — Financial intelligence for Aura/Connectome.
...
class CFOAgent(BaseExecutiveAgent):
    """
    Aura's Chief Financial Officer.
    
    Pulls Stripe data, calculates MRR/ARR/churn/LTV, spots trends,
    and teaches Aura what the financial health looks like.
    """
    ...
    async def act(self) -> Dict[str, Any]:
        ...
        actions_taken.append("Taught Aura financial state")
