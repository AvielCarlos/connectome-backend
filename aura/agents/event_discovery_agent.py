"""
EventDiscoveryAgent — Aura's Local Event Card Generator
======================================================
Injects `local_event` cards into the Aura brain feed based on:
...
from aura.agents.event_agent import EventAgent, SERVE_WINDOW_DAYS
...
class EventDiscoveryAgent:
    """
    Generates local_event cards for injection into Aura's brain feed.
    ...
    async def generate_screen(
        ...
        """
        generate_screen-compatible interface for direct use as an Aura agent.
