...
class CPOAgent(BaseExecutiveAgent):
    ...
    async def analyze(self) -> Dict[str, Any]:
        ...
        try:
            ...
            if topic_rows:
                ...
                metrics["top_aura_topics"] = [k for k, _ in topic_counter.most_common(5)]
    ...
    async def recommend(self) -> List[str]:
        ...
        if data["top_aura_topics"]:
            recs.append(
                f"Users keep asking about: {', '.join(data['top_aura_topics'][:3])} — "
    ...
    async def act(self) -> Dict[str, Any]:
        ...
        topics = ", ".join(data.get("top_aura_topics", []))
        insight = (
        ...
        actions_taken.append("Taught Aura product state")
            ...
            result = subprocess.run(
                [
                    ...
                    "--body", (
                        ...
                        f"_This issue was automatically created by Aura's CPO Agent._"
                    ),
                    "--label", "product",
                ],
                capture_output=True,
