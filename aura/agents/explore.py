"""
ExploreAgent — Aura's real-world connector.
        ...
        "adventure": [
            {
                ...
                "aura_note": "Perfect for your goal of seeking adventure",
            },
            {
                ...
                "aura_note": "Beginners welcome — they have intro sessions",
            },
            {
                ...
                "aura_note": "Guided tours available on weekends",
            },
        ],
        "food": [
            {
                ...
                "aura_note": "Farm-to-table menu that changes weekly",
            },
            {
                "name": "Noodle House",
                "rating": 4.4,
                ...
                "aura_note": "Authentic broth, slow-cooked for 12 hours",
            },
        ],
        "wellness": [
            {
                ...
                "aura_note": "First class free for new students",
            },
            {
                "name": "The Float Spa",
                "rating": 4.7,
                ...
                "aura_note": "60-min float sessions — incredible for clarity",
            },
        ],
        "creative": [
            {
                ...
                "aura_note": "Drop-in pottery classes, no experience needed",
            },
        ],
        "learning": [
            {
                ...
                "aura_note": "Top-rated courses in tech, business, and creativity",
            },
            {
                "name": "MasterClass",
                "rating": 4.8,
                ...
                "aura_note": "Learn from the world's best in any field",
            },
        ],
        "events": [
            {
                ...
                "aura_note": "Thousands of events happening in your city",
            },
            {
                "name": "Meetup",
                "rating": 4.5,
                ...
                "aura_note": "Find your tribe — groups for every interest",
            },
        ],
        "social": [
            {
                ...
                "aura_note": "Join a team, meet people, get active",
            },
        ],
        "travel": [
            {
                ...
                "aura_note": "Discover the world's most extraordinary places",
            },
        ],
    }
}
...
ORA_NOTES: Dict[str, List[str]] = {
    ...
    "events": [
        "Real-world experiences are what Aura's feed can't replace. Go.",
    ...
    async def _get_world_signal_card(
        ...
        try:
            ...
            return {
                ...
                "headline": row["title"],
                "aura_note": row["summary"] or "A relevant signal from the wider world.",
                "source": row["source"],
                "url": row["url"],
                "tags": tags,
                "items": [],
    ...
    async def _generate_video_card(
        ...
        video_mocks = {
            "learning": {
                ...
                "aura_note": "This technique alone could change how you approach every skill you want to build.",
            },
            "adventure": {
                ...
                "aura_note": "Watch this before you book — it'll make you excited, not nervous.",
            },
            "wellness": {
                ...
                "aura_note": "The most-recommended yoga channel in the world. Start here.",
            },
        }
