...
====================================
Reads a user's Twitter/X likes and engagement to bootstrap Aura's user model.
...
class TwitterSignalAgent:
    """
    Reads user's Twitter/X likes and engagement to bootstrap Aura's user model.
