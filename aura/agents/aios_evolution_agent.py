...
class AIOSEvolutionAgent:
    ...
    async def run_weekly_evolution(self) -> Dict[str, Any]:
        ...
        await execute(
            ...
            INSERT INTO aios_state
                (ruling_goals, featured_apps, aura_mission_statement, evolution_notes, user_count, computed_at)
        ...
        state = {
            ...
            "aura_mission_statement": mission,
    ...
    async def _mission_statement(self, goals: List[Dict[str, Any]], featured_apps: List[str]) -> str:
        ...
        fallback = (
            f"Aura, the brain of Connectome, is evolving the AI OS this week around {top_goal_text} "
        ...
        try:
            response = await self._openai.chat.completions.create(
                ...
                messages=[
                    {
                        "role": "system",
                        "content": "Write one clear, inspiring sentence for Aura's mission as the brain evolving Connectome's AI OS from collective human goals. No hype, no more than 28 words.",
                    },
                    {
                        "role": "user",
