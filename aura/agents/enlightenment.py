...
class EnlightenmentAgent:
    ...
    async def _generate_with_ai(
        ...
        prompt = f"""You are Aura, generating an enlightenment screen — content designed to shift perspective, open up thinking, and help a user see their life and the world differently.
