...
class BaseWorkerAgent(ABC):
    """Base class for all Aura worker agents."""
    ...
    async def report(self) -> str:
        """Summary for Aura. Override for custom summaries."""
    ...
    async def teach_aura(self, insight: str, confidence: float = 0.8) -> bool:
        """POST an insight to /api/aura/learn."""
        try:
