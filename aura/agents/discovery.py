...
from aura.data.activity_repository import get_activity_repository
...
class DiscoveryAgent:
    ...
    def _get_drive_agent(self):
        """Lazy-load DriveAgent from Aura brain to avoid circular imports."""
    ...
    async def _generate_from_drive_notes(
        ...
        Triggered when the user has few goals — helps Aura understand them better.
        ...
        try:
            ...
            if self.openai and settings.has_openai:
                prompt = f"""You are Aura, an AI dedicated to human fulfilment.
