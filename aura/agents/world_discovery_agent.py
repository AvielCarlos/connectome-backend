"""
WorldDiscoveryAgent — Aura's World-Aware Life Suggestion Engine
...
WORLD_CARD_TEMPLATES: Dict[str, List[str]] = {
    ...
    "no_goals_first_visit": [
        "Aura doesn't know you yet — and that's kind of exciting. What's the one area of your life that feels most alive right now?",
        ...
        "Aura's first question isn't about goals. It's about you. What's alive in you right now?",
    ],
...
class WorldDiscoveryAgent:
    """
    Generates world-aware life suggestion cards for Aura.
    ...
    async def _enhance_with_llm(
        ...
        try:
            ...
            prompt = f"""You are Aura — a warm, poetic, and practical AI companion for human growth.
