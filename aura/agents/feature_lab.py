"""
OraFeatureLab — Aura autonomously proposes and tests novel features.
...
Storage: uses aura_lessons table with lesson_type='feature_proposal' to avoid migrations.
"""
...
PROPOSAL_SOURCE = "feature_lab"  # stored in aura_lessons.source column
...
FALLBACK_PROPOSALS = [
    {
        ...
        "description": "A card that celebrates consecutive days of engagement with Aura, creating a positive habit loop",
    ...
    },
    {
        ...
        "description": "Every Monday, Aura surfaces a visual summary of the user's growth across domains",
...
class AuraFeatureLabAgent:
    """
    Aura's internal feature lab. Runs autonomously in the background,
    ...
    async def _llm_generate_proposal(self) -> Dict[str, Any]:
        ...
        system = (
            "You are Aura's research division. Your job is to generate novel hypotheses "
    ...
    async def store_proposal(self, proposal: Dict[str, Any]) -> str:
        """Store a proposal in the aura_lessons table."""
        ...
        await execute(
            """
            INSERT INTO aura_lessons (id, source, lesson, confidence, applied, created_at)
            VALUES ($1, $2, $3, $4, $5, $6)
            """,
    ...
    async def evaluate_proposal(self, proposal_id: str) -> Dict[str, Any]:
        ...
        """
        row = await fetchrow(
            "SELECT id, lesson FROM aura_lessons WHERE id = $1 AND source = $2",
        ...
        await execute(
            "UPDATE aura_lessons SET lesson = $1, applied = $2 WHERE id = $3",
            json.dumps(data),
