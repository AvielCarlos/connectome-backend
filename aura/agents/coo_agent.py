...
Identifies waste and inefficiency. Keeps Aura's cron jobs healthy.
"""
...
class COOAgent(BaseExecutiveAgent):
    """
    Aura's Chief Operating Officer.
    ...
    def _load_report_metadata(self, agent_name: str, now: datetime) -> Dict[str, Any]:
        from aura.agents.base_executive_agent import LOG_DIR
    ...
    async def act(self) -> Dict[str, Any]:
        ...
        actions_taken.append("Taught Aura operational state")
