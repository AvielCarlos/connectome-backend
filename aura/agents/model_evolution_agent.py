"""
ModelEvolutionAgent — Aura's model intelligence layer.

Knows what models exist, benchmarks them against Aura's specific tasks,
...
- Aura-specific task benchmarking (goal coaching, card gen, goal breakdown)
...
# ---------------------------------------------------------------------------
# Aura's benchmark tasks — evaluates models on what Aura actually does
# ---------------------------------------------------------------------------
...
BENCHMARK_TASKS = [
    {
        ...
        "system": "You are Aura, an AI that helps people find genuine fulfilment through their goals.",
    },
    {
        ...
        "system": "You are Aura, generating discovery cards that feel like personal revelations.",
    },
    {
        "name": "goal_breakdown",
        "prompt": (
        ...
        "system": "You are Aura, a life coach specializing in breaking goals into actionable steps.",
    },
    {
        ...
        "system": "You are Aura. Be warm, honest, and genuinely helpful.",
    },
]
...
class ModelEvolutionAgent:
    """
    Aura's model intelligence. Benchmarks providers against Aura's real tasks,
    ...
    async def benchmark_model(self, model_spec: Dict[str, str]) -> Dict[str, Any]:
        ...
        Caches in Redis: aura:model_benchmark:{model_id} TTL 7 days.
        """
        from core.redis_client import get_redis

        model_id = model_spec["id"]
        provider = model_spec["provider"]
        redis_key = f"aura:model_benchmark:{model_id}"
    ...
    async def recommend_upgrade(
        ...
        try:
            ...
            await r.set("aura:model:rollback", json.dumps(rollback_data), ex=7 * 24 * 3600)
        except Exception as e:
