...
class CoachingAgent:
    ...
    async def _generate_with_ai(
        ...
        aura_lessons = user_context.get("aura_lessons", [])
        ...
        # Aura lessons relevant to coaching
        lessons_hint = ""
        if aura_lessons:
  ...
  without pressure. Be direct and genuine.""",
        ...
        prompt = f"""You are Aura — the supreme intelligence layer in this person's life, like JARVIS to Iron Man.
...
Return ONLY valid JSON."""
        ...
        try:
            response = await self.openai.chat.completions.create(
                model="gpt-4o",
                messages=[
                    {"role": "system", "content": "You are Aura, a direct and effective AI life coach. Return only valid JSON."},
