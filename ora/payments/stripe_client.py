"""
Stripe Payment Client — Ora's gateway to the financial world.

Uses direct httpx calls to the Stripe REST API (no SDK dependency).
More reliable in constrained environments and gives Ora full visibility
...
class StripeClient:
    """
    Ora's Stripe integration. All calls are async and use basic auth
