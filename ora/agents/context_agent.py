...
Reads time-based signals (and optionally calendar) to inform Ora's content
...
class ContextAgent:
    """
    Reads calendar + health signals to inform Ora's content decisions.
    ...
    async def get_user_context_signals(self, user_id: str) -> Dict[str, Any]:
        """
        Returns context hints Ora uses to pick appropriate content:
