"""
MetaAgent — Ora reflects on her own performance and queues improvements.
...
Outputs a JSON report saved to Redis key 'ora:meta:report' with:
{
...
REDIS_KEY = "ora:meta:report"
REPORT_TTL = 24 * 3600  # 1 day


class MetaAgent:
    """
    Ora's self-reflection agent. Analyzes engagement patterns and produces
    ...
    async def _suggestions_llm(
        ...
        prompt = f"""You are Ora, an AI system analyzing your own performance data to improve.
