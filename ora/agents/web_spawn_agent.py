"""
WebSpawnAgent — Ora's surface creation engine.

For explorer/sovereign users, Ora can generate a dedicated web page and
...
The generated page can be ANYTHING Ora decides is best:
...

{
  ...
  "sections": [
    ...
    // Ora freely chooses from (or combines) these section kinds:
...
- Endpoints:
    GET  /data   — returns the surface spec + user-specific data from ora_surfaces table
...
- Stores dynamic data in ora_surfaces.spec['user_data'] as JSONB
"""
...
class WebSpawnAgent:
    """Ora's surface creation engine — fully generative, no templates."""
            ...
            "sections": [
                {
                    "kind": "header",
                    "title": title,
                    "subtitle": "Your personalized Ora surface",
                    "icon": "✦",
                },
                {
                    "kind": "text",
                    "content": f"Ora is getting to know your goal: **{request}**\n\nCome back once Ora has had time to personalize this page for you.",
                    "style": "callout",
                },
            ],
            "initial_data": {},
