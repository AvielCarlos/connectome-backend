...
Part of Ora's Executive Council. The CUXD is responsible for:
...
Runs weekly (Thursdays 9am). Feeds design lessons to Ora continuously.
"""
...
DESIGN_SYSTEM = {
    ...
    "colors": {
        "primary": "#00d4aa",      # Ora teal — action, achievement
...
class CUXDAgent(BaseExecutiveAgent):
    ...
    async def act(self) -> Dict[str, Any]:
        ...
        actions_taken.append(f"Taught Ora {taught} UX lessons")
