"""
DriveAgent — Google Drive indexer for Ora
=========================================
Reads Avi's Google Drive via the `gog` CLI, creates OpenAI embeddings,
and stores them in pgvector so Ora can do semantic search over personal notes.
...
class DriveAgent:
    ...
    Used by Ora to surface relevant personal notes during coaching.
    """
